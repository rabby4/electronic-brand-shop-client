...
const Acer = () => {
    ...
    const acerProduct = allProducts.filter(product => product.brand.toLowerCase() === 'acer'.toLowerCase())
        ...
        <div>
            ...
            <div className="container mx-auto">
                <div className='lg:px-0 md:px-10 px-5'>
                    <div className='my-20'>
                        <h2 className='lg:text-5xl md:text-4xl text-3xl font-bold text-center'>Acer Products</h2>
                    </div>
                    <div className={acerProduct.length !== 0 && 'block'}>
                        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
                            {
                                acerProduct.slice(0, 8).map(product => <div key={product._id}>
                    ...
                    <div className={acerProduct.length == 0 ? 'block' : 'hidden'}>
