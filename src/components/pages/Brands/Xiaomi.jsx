...
const Xiaomi = () => {
    ...
    const xiaomiProduct = allProducts.filter(product => product.brand.toLowerCase() === 'xiaomi'.toLowerCase())
                ...
                <div className='lg:px-0 md:px-10 px-5'>
                    ...
                    <div className={xiaomiProduct.length !== 0 && 'block'}>
                        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
                            {
                                xiaomiProduct.slice(0, 8).map(product => <div key={product._id}>
                    ...
                    <div className={xiaomiProduct.length == 0 ? 'block' : 'hidden'}>
